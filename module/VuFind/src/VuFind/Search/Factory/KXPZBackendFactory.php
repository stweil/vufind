...
/**
 * Factory for the Solr based KXPZ backend.
 *
 * PHP version 8
 *
 ...
 * @link     https://vufind.org Main Site
 */
class KXPZBackendFactory extends SolrDefaultBackendFactory
{
    /**
     * Constructor.
     */
    ...
    {
        parent::__construct();
        $this->mainConfig = $this->searchConfig = $this->facetConfig = 'KXPZ';
        $this->searchSpecsConfig = 'kxpzsearchspecs.yaml';
    }
