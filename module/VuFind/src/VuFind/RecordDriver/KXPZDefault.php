...
/**
 * Default model for KXPZ records -- used when a more specific model based on
 ...
 */
class KXPZDefault extends SolrMarc
{
    /**
    ...
    protected $sourceIdentifier = 'KXPZ';
    ...
    {
        return parent::getHierarchyType() ? 'kxpz' : false;
    }
